 ...
 *        Vystup neni shodny 1:1, vzhledem k tomu, ze pouzity algoritmus obcas
 *        vybere jinak, pokud je vic moznosti jak diff zapsat. Je vsak zaruceno,
 *        ze pokud se pouzije vystup tohoto algoritmu jako patch, pak vysledek
 *        bude spravny.
 * 
 ...
 * 
 *        Tato implementace nedela zadne presouvani ani kopirovani retezcu,
 *        takze by mela byt rychlejsi nez CreateNormalDiff. Cely seznam zmen
 *        projde jen jednou a pocita pritom indexy hranic zmen.
 * 
...
public class CreateUnifiedDiff extends CreateDiff {
	 ...
	 * 
	 *        Konstruktor vytvori diff soubor, ktery obsahuje zadany pocet
	 *        kontextovych radku.
	 * 
	 * @param fst
	 *            Prvni ze souboru, ktere se maji porovnavat.
	 * @param snd
	 *            Druhy ze souboru, ktere se maji porovnavat.
	 * @param con
	 *            Pocet kontextovych radku.
	 ...
	 * 
	 *        Tento konstruktor uz diff nevytvari, pouze vezme predem vytvoreny
	 *        a zformatuje jej.
	 * 
	 * @param fst
	 *            Prvni soubor, z ktereho diff pochazi, slouzi k ziskani nazvu.
	 * @param snd
	 *            Druhy soubor, z ktereho diff pochazi, slouzi k ziskani nazvu.
	 * @param d
	 *            Diff.
	 */
	 ...
	 * 
	 *        Vytvori hlavicku diff souboru, ta obsahuje cestu k souborum a
	 *        timestamp.
	 * 
	 * @param fst
	 *            Prvni ze souboru, ktere se maji porovnavat.
	 ...
	 * 
	 *        Premeni seznam zmen zpocitany predkem CreateDiff ve vystupni
	 *        soubor. Zpocita indexy zacatku a konce oblasti zmen tak, aby je
	 *        metoda addChanges mohla pouzit k vytvoreni diff souboru.
	 */
	 ...
	 * 
	 *        Vytvori ze zadanych indexu zmen diff soubor. Doplni znacky a cisla
	 *        radku.
	 */
	protected void addChanges() {
		if (context == 0 && endFst == startFst) {
			...
			stringRepresentation += "@@ -" + (startFst + 1) + "," + (endFst - startFst) + " +" + (startSnd + 1) + ","
					+ (endSnd - startSnd) + " @@\n";
		}
